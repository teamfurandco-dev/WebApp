...
const Niche = () => {
  ...
  return (
    <div className="min-h-screen bg-[#EFF7F2] text-[#14522D] font-serif">
            ...
            >
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-end">
                ...
                <div className="relative z-10 text-[#FDFCF0]">
                   <span className="text-xs font-sans tracking-widest uppercase mb-2 block text-[#FBBF24]">{story.category}</span>
      ...
      <section className="py-32 bg-[#14522D] text-[#FDFCF0] overflow-hidden">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-16">
          <div className="w-full md:w-1/2">
             <div className="aspect-[4/5] bg-[#A0522D] rounded-t-full opacity-80 mix-blend-screen"></div>
          </div>
          <div className="w-full md:w-1/2">
             <span className="text-[#FBBF24] font-sans tracking-widest uppercase mb-4 block">The Hands Behind The Product</span>
             ...
             <button className="text-[#FBBF24] border-b border-[#FBBF24] pb-1 hover:text-white hover:border-white transition-colors">Read Full Journal Entry</button>
          </div>
        </div>
      </section>
