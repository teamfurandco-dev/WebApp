      ...
      >
        <div className="bg-white rounded-[3rem] shadow-2xl overflow-hidden border border-black/5 p-8 md:p-12">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-peace-sans font-bold text-black mb-3">Join the Club</h1>
            <p className="text-black/50 text-sm font-medium">Begin your journey to premium pet care</p>
          </div>
