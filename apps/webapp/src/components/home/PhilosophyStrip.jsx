                    ...
                    <div className="flex-1 relative overflow-hidden">
                        ...
                        >
                            {duplicatedValues.map((value, index) => (
                                <div
                                    key={index}
                                    className="flex flex-col items-center justify-center text-center gap-4 group flex-shrink-0 w-[180px]"
                                >
                                    <div className="p-4 rounded-full bg-[#FAF8F5] group-hover:bg-[#F2E8D5] transition-colors duration-300">
                                        <value.icon className="w-8 h-8 text-black/80" strokeWidth={1} />
                                    </div>
                                    <span className="text-sm md:text-base font-sans font-medium text-black/80">
                                        {value.label}
                                    </span>
                                </div>
                            ))}
